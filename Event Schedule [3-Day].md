...
*Day 1 births the fest, establishing the technical and cultural foundation.*

* **9:30 AM | The Kindling (Inauguration)** 
  * Lamp lighting, welcome address, and official fest reveal. 
  * Sponsor acknowledgements and opening keynote. 
* **11:00 AM | Syndesis (API Building with FastAPI)** 
  * Building a Python script to build and test a live endpoint. 
...
*This is mainly focused on school-level activities, running parallely to the Contests.*

* **9:00 AM | Genesis Track Arrival** 
  * Class 9 to 12 school students arrive for dedicated orientation. 
* **9:30 AM | Eureka Pitch (Genesis Track)** 
...
## **Day 3: TELOS (Fulfillment & Conclusion)**

*Day 4 concludes the arc with final project exhibitions, judging, and the valediction ceremony.*
...
* **10:00 AM | Eureka Pitch Finals** 
  * Top 5 college and top 3 school teams deliver extended 3-minute pitches \+ 3-minute Q\&A. 
* **2:30 PM | The Tribunal (Hackathon Judging)** 
  * Archithon teams present their finalized builds to the judging council. 
* **4:00 PM | Results & Genesis Departure** 
  * Final results compiled. School students depart campus safely. 
* **4:30 PM | Apotheosis (Valediction)** 
  * Highest honors awarded. Prize distribution for all events. 
* **5:30 PM | Epilogos** 
  * Final closing remarks. Syntaxis 2026 officially ends.
